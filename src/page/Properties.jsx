      ...
      <div className="py-16 bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <Swiper
            ...
            spaceBetween={20}
            slidesPerView={3}   // doim ekranda 3 ta ko‘rinadi
            navigation
            pagination={{ clickable: true }}
            breakpoints={{
              0: { slidesPerView: 1 },     // 📱 kichkina ekran
              640: { slidesPerView: 2 },   // 📱 o‘rta ekran
              1024: { slidesPerView: 3 },  // 💻 katta ekran — 3 ta har doim
            }}
          >
